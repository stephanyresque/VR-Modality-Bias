#!/usr/bin/env python
"""Diagnostic (CPU-only, no SPARC / no generation): inspect the image-token
layout in the prefill input_ids and audit SPARC's contiguous-block assumption.

Run: python scripts/audit_image_token_layout.py --model qwen|smol [--image-path P] [--prompt-key K]
"""
