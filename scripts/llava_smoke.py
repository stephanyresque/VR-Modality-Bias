#!/usr/bin/env python
"""Block-1 smoke for LLaVA-1.5-7B: the wrapper loads, introspection resolves
(n_layers=32, lm_head) and one greedy caption comes out as coherent prose.

Run: python scripts/llava_smoke.py [--image-id ID] [--max-new-tokens N]
"""
